...
static void delta(uint dm, uint dk, uint dn, uint _bsize, uint _asso, int* Sizes)
{
	...
	thread t3(inner_product1, &A01, &B01, &C01, M, K, N, A, B, C);
	thread t4(outer_product1, &A11, &B11, &C11, M, K, N, A, B, C);
	thread t5(gustavson1, &A21, &B21, &C21, M, K, N, A, B, C);
	...
	////////////Save results:///////////////////////////////////////////////////////////////////////////////////////////
	Cache::info(&A0, &A1, &A2, &B0, &B1, &B2, &C0, &C1, &C2, &A01, &A11, &A21, &B01, &B11, &B21, &C01, &C11, &C21, dm, dk, dn, _bsize, _asso);
